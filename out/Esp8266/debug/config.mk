...
MQTT_NO_COMPAT = 
PIP_ARGS = 
PROJECT_DIR = /home/angelo/Software/esp8266/project/SoilMeter_nonos
RBOOT_BIG_FLASH = 0
RBOOT_GPIO_ENABLED = 0
RBOOT_GPIO_SKIP_ENABLED = 0
RBOOT_LD_0 = out/Esp8266/debug/build/rom0.ld
RBOOT_LD_1 = out/Esp8266/debug/build/rom1.ld
...
RBOOT_TWO_ROMS = 0
SDK_BASE = /opt/sming/Sming/Arch/Esp8266/Components/esp8266/ESP8266_NONOS_SDK
...
CACHED_VAR_NAMES := COM_OPTS COM_PORT COM_PORT_ESPTOOL COM_PORT_GDB COM_SPEED COM_SPEED_ESPTOOL COM_SPEED_SERIAL DEBUG_PRINT_FILENAME_AND_LINE DEBUG_VERBOSE_LEVEL DISABLE_SPIFFS DISABLE_WIFI ENABLE_CMD_EXECUTOR ENABLE_CUSTOM_HEAP ENABLE_CUSTOM_LWIP ENABLE_CUSTOM_PWM ENABLE_ESPCONN ENABLE_GDB ENABLE_HTTP_SERVER_MULTIPART ENABLE_LEGACY_BUILD ENABLE_LWIPDEBUG ENABLE_SMART_CONFIG ENABLE_SSL ENABLE_TASK_COUNT ENABLE_WPS FULL_COMPONENT_BUILD GDB_CMDLINE GDB_UART_SWAP HTTP_SERVER_EXPOSE_DATE HTTP_SERVER_EXPOSE_NAME HTTP_SERVER_EXPOSE_VERSION KILL_TERM LOCALE MQTT_NO_COMPAT PIP_ARGS PROJECT_DIR RBOOT_BIG_FLASH RBOOT_GPIO_ENABLED RBOOT_GPIO_SKIP_ENABLED RBOOT_LD_0 RBOOT_LD_1 RBOOT_LD_TEMPLATE RBOOT_ROM0_ADDR RBOOT_ROM1_ADDR RBOOT_ROM2_ADDR RBOOT_ROM_0 RBOOT_ROM_1 RBOOT_RTC_ENABLED RBOOT_SILENT RBOOT_SPIFFS_0 RBOOT_SPIFFS_1 RBOOT_TWO_ROMS SDK_BASE SERVER_OTA_PORT SPIFF_BIN SPIFF_FILEDESC_COUNT SPIFF_FILES SPIFF_SIZE SPI_MODE SPI_SIZE SPI_SPEED SSL_DEBUG STRICT STRING_OBJECT_SIZE TASK_QUEUE_LENGTH TERMINAL TRACE USER_CFLAGS USE_US_TIMER WIFI_PWD WIFI_SSID
